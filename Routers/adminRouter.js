...
router.get("/getSpecificTPODetails/:tpo_id", async (req, res) => {
  try {
    const specificTPODetails = await TPODetails.findOne({
      tpo_id: req.params.tpo_id,
    });
...
router.get("/getTPODetailsByDepartment/:tpo_department", async (req, res) => {
  try {
    const tpoDetailsByDepartment = await TPODetails.find({
      tpo_department: req.params.tpo_department,
    });
...
router.get("/getTPODetailsByDesignation/:tpo_designation", async (req, res) => {
  try {
    const tpoDetailsByDesignation = await TPODetails.find({
      tpo_designation: req.params.tpo_designation,
    });
...
router.post("/addFacultyDetails", async (req, res) => {
  try {
    const check = await FacultyDetails.find({
...
router.delete("/delete-faculty/:id", async (req, res) => {
  try {
    const deletedFacultyDetails = await FacultyDetails.deleteOne({
...
router.get("/getSpecificFacultyDetails/:faculty_id", async (req, res) => {
  try {
    const specificFacultyDetails = await FacultyDetails.findOne({
...
router.get(
  "/getAllFacultyDetailsByDepartment/:faculty_department",
  async (req, res) => {
    try {
      const allFacultyDetailsByDepartment = await FacultyDetails.find({
        faculty_department: req.params.faculty_department,
      });
...
router.get(
  "/getAllFacultyDetailsByDesignation/:faculty_designation",
  async (req, res) => {
    try {
      const allFacultyDetailsByDesignation = await FacultyDetails.find({
        faculty_designation: req.params.faculty_designation,
      });
...
router.get(
  "/getAllFacultyDetailsByDepartmentAndDesignation/:faculty_department/:faculty_designation",
  async (req, res) => {
    try {
      const allFacultyDetailsByDepartmentAndDesignation =
        await FacultyDetails.find({
          faculty_department: req.params.faculty_department,
          faculty_designation: req.params.faculty_designation,
        });
...
router.get("/getSpecificTTODetails/:tto_id", async (req, res) => {
  try {
    const specificTTODetails = await TTODetails.findOne({
      tto_id: req.params.tto_id,
    });
